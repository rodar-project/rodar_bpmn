defmodule Bpmn.Event.Start.TriggerTest do
  ...
  describe "register/1" do
    ...
    test "returns empty list for process without triggers" do
      ...
      Bpmn.Registry.register("plain-proc", {:bpmn_process, %{id: "plain-proc"}, elements})
  ...
  describe "auto-instantiation" do
    test "message event creates a new process instance" do
      ...
      before_count = length(Bpmn.Observability.running_instances())
      ...
      after_count = length(Bpmn.Observability.running_instances())
