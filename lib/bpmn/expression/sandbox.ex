defmodule Bpmn.Expression.Sandbox do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Bpmn.Expression.Sandbox.eval("1 + 2")
      {:ok, 3}

      iex> Bpmn.Expression.Sandbox.eval("data[\\"x\\"] > 5", %{"data" => %{"x" => 10}})
      {:ok, true}

      iex> Bpmn.Expression.Sandbox.eval("System.cmd(\\"ls\\", [])")
      {:error, "disallowed: module call System.cmd/2"}

      iex> Bpmn.Expression.Sandbox.eval("File.read!(\\"/etc/passwd\\")")
