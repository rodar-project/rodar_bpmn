defmodule Bpmn.Compensation do
  @moduledoc """
  ...
  def register_handler(context, activity_id, handler_id) do
    ...
    Bpmn.Context.put_meta(context, :compensation_handlers, current ++ [entry])
  end
  ...
  """
  @spec compensate_activity(pid(), String.t()) :: Bpmn.result()
  ...
  """
  @spec compensate_all(pid()) :: Bpmn.result()
  ...
  def remove_handlers(context, activity_id) do
    ...
    Bpmn.Context.put_meta(context, :compensation_handlers, updated)
  end
  ...
  def handlers(context) do
    Bpmn.Context.get_meta(context, :compensation_handlers) || []
  end
  ...
  defp execute_handler(context, %{handler_id: handler_id}) do
    ...
    case Map.get(process, handler_id) do
      ...
      elem -> Bpmn.execute(elem, context)
    end
  end
end
