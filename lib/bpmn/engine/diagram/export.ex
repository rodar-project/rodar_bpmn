defmodule Bpmn.Engine.Diagram.Export do
  @moduledoc """
  Exports a parsed BPMN diagram map back to BPMN 2.0 XML.

  This is the inverse of `Bpmn.Engine.Diagram.load/1`. Given a diagram map
  ...
  ## Example
      ...
      iex> diagram = Bpmn.Engine.Diagram.load(xml)
      iex> exported = Bpmn.Engine.Diagram.Export.to_xml(diagram)
  ...
  ## Parameters
    ...
    * `diagram` - A diagram map as returned by `Bpmn.Engine.Diagram.load/1`
