...
```elixir
Rodar.Hooks.register(context, :after_node, &MyApp.Metrics.record/1)
Rodar.Hooks.register(context, :after_node, &MyApp.AuditLog.write/1)
```
...
```elixir
Rodar.Hooks.unregister(context, :before_node)
```
