...
- `lib/rodar_bpmn/workflow.ex` — Functional workflow API and `use` macro (Layer 1)
- `lib/rodar_bpmn/workflow/` — Workflow GenServer abstraction (`server.ex`, Layer 2)
